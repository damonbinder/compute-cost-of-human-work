...
<tbody>
<tr>
 <td>kAlertStdAlert0KButton</td>
 <td>1</td>
 <td>The OK push button. The default text for this push button is “OK”.</td>
</tr>
<tr>
 <td>kAlertStdAlertCancelButton</td>
 <td>2</td>
 <td>The Cancel push button(optional). The default text for this push button is “Cancel”.</td>
</tr>
<tr>
 <td>kAlertStdAlertOtherButton</td>
 <td>3</td>
 <td>A third push button(optional). The default text for this push button is “Don't Save”.</td>
</tr>
<tr>
