...
If you have a few components of one type, look for a code that's the same on all of them -- that will be the part number, the other codes willbe date- orbatch codes of no interest.
...
The internet has many resources to assist you - search for "IC Manufacturers logos" or "SMD codes" if you need more information. And look up "EIA-96" to decode SMD resistors with what looks like a weird 2-numberplus 1-letter code.
...
I have a bag of transistors labelled OV8F which have stubbornly refused to be identified. SMD components can be dificult or impossible to identify, as they often have shortened part numbers on them. Even with the considerable resources on the internet, they are not easy.
...
- OwON Ow16B Digital Multimeter with Bluetooth (SKU18780) www.elektor.com/18780
